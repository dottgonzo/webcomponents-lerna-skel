...
async function run() {
    ...
    const baseCode = `function addComponent(componentName) {
        if (!document.getElementById("skel-" + componentName + "-script")) {
            const script = document.createElement("script");
            script.id = "skel-" + componentName + "-script";
            script.src = "https://cdn.jsdelivr.net/npm/@htmlbricktest/skel-" + componentName + "@${pkg.version}/release/release.js";
